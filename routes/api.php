...
Route::get('/countries', [CountryController::class, 'index']); // Public access to countries list for registration
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'role:admin', 'user.status'])->group(function () {
        ...
        Route::post('/tvseries/{tvSerie}/complete-update', [TvSerieController::class, 'updateComplete']);
